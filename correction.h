...
class Correction : public Tree {
  ...
  public:
    ...
    Correction(const std::shared_ptr<Equation> eq, std::string lab = "") : Tree(eq, lab) { }
    ...
    OutStream generate_bc(const std::string, std::shared_ptr<BinaryContraction>) const override;
