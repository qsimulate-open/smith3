...
string RDM::generate(string indent, const string tag, const list<shared_ptr<const Index>>& index, const list<shared_ptr<const Index>>& merged, const string mlab, vector<string> in_tensors, const bool use_blas) {
...
string RDM::generate_not_merged(string indent, const string tag, const list<shared_ptr<const Index>>& index, vector<string> in_tensors) {
  stringstream tt;
  tt << indent << "{" << endl;
...
string RDM::generate_merged(string indent, const string tag, const list<shared_ptr<const Index>>& index, const list<shared_ptr<const Index>>& merged, const string mlab, vector<string> in_tensors, const bool use_blas) {
  stringstream tt;
  //indent += "  ";
  const string itag = "i";
  const string lindent = indent;
...
string RDM::make_blas_multiply(string dindent, const list<shared_ptr<const Index>>& loop, const list<shared_ptr<const Index>>& index) {
  stringstream tt;
...
pair<string, string> RDM::get_dim(const list<shared_ptr<const Index>>& di, const list<shared_ptr<const Index>>& index) const {
  vector<string> s, t;
...
string RDM::make_sort_indices(string indent, string tag, const list<shared_ptr<const Index>>& loop) {
  stringstream tt;
    vector<int> done;
    // then fill out others
    for (int i = 0; i != index_.size(); ++i) {
...
string RDM::multiply_merge(const string itag, string& indent, const list<shared_ptr<const Index>>& merged) {
  stringstream tt;
  if (rank() == 0) {
...
string RDM::fdata_mult(const string itag, const list<shared_ptr<const Index>>& merged) {
  stringstream tt;
  tt << " * " << "fdata" << "[";
...
string RDM::make_odata(const string itag, string& indent, const list<shared_ptr<const Index>>& index) {
  stringstream tt;
...
string RDM::make_sort_loops(const string itag, string& indent, const list<shared_ptr<const Index>>& loop, vector<string>&  close) {
  stringstream tt;
  // start sort loops
  for (auto& i : loop) {
    const int inum = i->num();
