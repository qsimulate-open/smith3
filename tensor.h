...
class Tensor {
  ...
  public:
    ...
    std::string generate_get_block(const std::string, const std::string, const bool move = false, const bool noscale = false, const bool rev = false) const;
    std::string generate_scratch_area(const std::string, const std::string, const bool zero = false, const bool rev = false) const;
    std::string generate_sort_indices(const std::string, const std::string, const std::list<std::shared_ptr<Index> >&, const bool op = false, const bool rev = false) const;
