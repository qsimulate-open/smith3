...
class Density : public Tree {
  protected:
    /// Target indices, these are not to be summed over..these are set at other level, may not need here.
  ...
  public:
    ...
    Density(const std::shared_ptr<ListTensor> l, std::string lab) : Tree(l, lab) {};
    virtual ~Density() {};
