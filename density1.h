...
/// Derived class for density1 tree. This is the unrelaxed one-body density matrix, dm1, 2<0|E_pq|1>
class Density1 : public Tree {
  protected:

  public:
    /// Construct tree of equation pointers and set tree label.
    Density1(const std::shared_ptr<Equation> eq, std::string lab = "") : Tree(eq, lab) { }
    Density1(const std::shared_ptr<ListTensor> l, std::string lab, const bool t) : Tree(l, lab, t) { }
    virtual ~Density1() { }
