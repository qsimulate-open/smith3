...
int main() {
  ...
  shared_ptr<Operator> ex_0(new Ex("x", "c", "a", "a"));
  shared_ptr<Operator> t20(new Op("t2", "a", "a", "x", "c"));
  shared_ptr<Operator> r0(new Op("r", "a", "a", "x", "c"));
  ...
  shared_ptr<Operator> t2dagger0(new Op("t2dagger", "x", "c", "a", "a"));
